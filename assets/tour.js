...
(function () {
  ...
  var SCRIPT = [
    ...
    { st: 0, page: 'main', sel: '#d-attr',
      t: 'AI 보유목적 분류',
      b: '담당 자재의 <b>보유목적 분류 현황</b>입니다. 그중 <b>AI가 변경을 제안한 값</b>을 ' +
         '따로 세어 보여 줍니다 · 사람이 볼 몫이 몇 품목인지 여기서 먼저 잡습니다.' },

    { st: 0, page: 'main', sel: '#d-stock',
      t: 'AI 적정재고 분석',
      b: '분류한 <b>보유목적에 맞추어</b> AI가 적정재고를 판단합니다 · ' +
         '<b>발주가 필요한 자재</b>와 <b>감축 가능 금액</b>을 한눈에 봅니다.' },

    { st: 0, page: 'main', sel: '#d-due',
      t: '적정구매시점',
      b: '이번 주 <b>내가 발행한 WO</b>의 설비에 필요한 자재를 알려 줍니다 · ' +
         '언제까지 신청해야 하는지도 함께 셉니다.' },
