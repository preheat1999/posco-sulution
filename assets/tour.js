...
(function () {
  ...
  var STEPS = {
    ...
    'return': [
      ['#table-card .card-tools a, #table-card', 'QR 을 찍으면 시작합니다',
       '자재식별표의 QR 을 폰으로 찍으면 자재 정보가 뜨고, 확인하면 반납 화면으로 넘어갑니다.'],
      ['#tabs', '사람이 정하는 건 수량입니다',
       '물품 상태는 반납한 뒤 검사에서 정합니다 · 「반납 완료」 칸에서만 보입니다.'],
      ['#effect', '신청서 초안이 채워집니다',
       '수량은 고칠 수 있고 회수 금액이 따라 바뀝니다 · 반납하면 적정재고 숫자도 같이 움직입니다.']
    ]
  };
