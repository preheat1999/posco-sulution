...
window.CATALOG = (function () {
  ...
  var SCREENS = {
    main: {
      ...
      what: '담당 자재 743품목의 지금 상태를 한 화면에 모은다 · 보유 금액과 추이선, ' +
        'AI 속성 분류 도넛, 적정재고 요약, 정비 마감, 오늘 할 일.',
      does: ['숫자를 눌러 그 값이 나온 화면으로 바로 간다',
             '속성 판단의 확정 대기 건수를 알려 준다 (다른 화면이 아직 옛 속성을 쓴다는 뜻)'],
      parts: {
        '추이선': '월별 보유 금액 · 우리 부서가 오르면 코랄, 내리면 파랑이다. 입고일자 누적으로 만든다',
        '도넛': '743품목을 손대야 하는 갈래로 나눈다 · 보험품→계획품 · 계획품→보험품 · 현행유지 · 판단 완료 · 판정일치 · 배제',
        '오늘 할 일': '지금 해야 하는 것만 큰 줄로 · 나머지는 접어 둔다'
      }
    },
    attr: {
